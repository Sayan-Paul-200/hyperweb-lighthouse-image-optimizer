<?php
/**
 * Tests for image domain scope boundaries.
 *
...
final class ImageScopePolicyTest extends TestCase {
	...
	/**
	 * Read image-domain runtime source files.
	 *
	 * @return array<string,string>
	 */
	private function image_source_files(): array {
		$root      = dirname( __DIR__, 3 );
		$directory = $root . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'Image';
		$sources   = array();
