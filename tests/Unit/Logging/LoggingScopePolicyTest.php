<?php
/**
 * Tests for logging subphase scope boundaries.
 *
...
/**
 * Verifies Subphase 1.4 does not introduce later-phase behavior.
 */
final class LoggingScopePolicyTest extends TestCase {

	/**
	 * Test no later-phase hooks or APIs are introduced with logging.
	 *
	 * @return void
	 */
	public function test_logging_foundation_does_not_introduce_later_phase_behavior(): void {
		$forbidden_patterns = array(
			...
			'loading optimization hook' => '/\bwp_get_loading_optimization_attributes\b/',
